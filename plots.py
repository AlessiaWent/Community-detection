...
plt.ylim(ymin =0)
plt.xlim(xmin=0)
plt.savefig('24cores_table3.png')
plt.close()

dat = np.loadtxt('table4_times')
A = dat[:,0]
B = dat[:,1]
plt.plot(A,B,label = 'Parallel part', marker = 'o')
plt.title('Community detection algorithm with output for table4, 24 processors (cosilt)')
plt.xlabel('Size of dataset')
plt.ylabel('Elapsed time')
plt.ylim(ymin =0)
plt.xlim(xmin=0)
plt.savefig('24cores_table4.png')
plt.close()
